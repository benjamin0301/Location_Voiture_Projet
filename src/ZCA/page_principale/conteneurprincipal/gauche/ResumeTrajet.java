...
public class ResumeTrajet extends JPanel {
    public ResumeTrajet() {
        ...
        labelResume.setBackground(Color.decode("#C8A100")); // Couleur jaune moutarde
        ...
        zoneTexte.setBackground(Color.decode("#FFD700")); // Couleur de fond jaune
        ...
        panelBouton.setBackground(Color.decode("#FFD700"));
        add(panelBouton, BorderLayout.SOUTH);

        // Ajout d'une bordure noire autour du conteneur
