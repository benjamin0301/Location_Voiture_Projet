...
public class Footer extends JPanel
{
    public Footer()
    {
        ...
        setBackground(Color.decode("#5E17EB"));

        JPanel pa = new JPanel();
        pa.setBackground(Color.decode("#5E17EB"));
        ...
        labelFooter.setBackground(Color.decode("#5E17EB"));
        ...
        labelFooter1.setBackground(Color.decode("#5E17EB"));
