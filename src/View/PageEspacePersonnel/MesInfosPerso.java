...
public class MesInfosPerso extends JPanel
{
    ...
    public MesInfosPerso(ClientModel clientModel) throws SQLException, ClassNotFoundException
    {
    ...
    public MesInfosPerso(EmployeModel employeModel) throws SQLException, ClassNotFoundException
    {
        ...
        JLabel prenom = new JLabel("Votre prénom : " + employe.getPrenom());
        prenom.setPreferredSize(new Dimension(300, 45));
        prenom.setFont(new Font("Georgia", Font.PLAIN, 20));
        panelA.add(prenom);

        JLabel nom = new JLabel("Votre nom : " + employe.getNom());
        nom.setPreferredSize(new Dimension(300, 45));
        nom.setFont(new Font("Georgia", Font.PLAIN, 20));
        panelA.add(nom);

        JLabel dn = new JLabel("Votre mail " + employe.getMail());
        dn.setPreferredSize(new Dimension(300, 45));
        dn.setFont(new Font("Georgia", Font.PLAIN, 20));
        panelA.add(dn);
        ...
        JLabel id = new JLabel("Votre ID : " + employe.getId_employe());
        id.setPreferredSize(new Dimension(300, 45));
        id.setFont(new Font("Georgia", Font.PLAIN, 20));
        panelB.add(id);
        ...
        JLabel mdp = new JLabel("Votre mot de passe : " + employe.getMdp());
        mdp.setPreferredSize(new Dimension(300, 45));
        mdp.setFont(new Font("Georgia", Font.PLAIN, 17));
        panelB.add(mdp);
        ...
        JLabel CFR = new JLabel(String.valueOf(employe.getNum_tel()));
        CFR.setPreferredSize(new Dimension(60, 30));
        CFR.setHorizontalAlignment(SwingConstants.CENTER);
